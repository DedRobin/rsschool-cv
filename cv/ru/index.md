...
Технологии:
React, Next.js, Tailwind CSS, Redux, REST, GraphQL

Изучил:
- командное ведения проекта с использованием системы контроля версий Git
- основы библиотеки React, фреймворка Next.js, менеджера состояния Redux
- подключение стороннего сервиса аутентификации Firebase

Реализация:
- регистрация и аутентификация через сторонний сервис Firebase (клиент <-> web-сервер <-> сервис Firebase)
- страница с формой для составления и отправки HTTP запросов по URL с последующим выводом ответа и статуса
- страница с формой составления и отправки GraphQL запросов по URL c последующим выводом ответа и статуса
